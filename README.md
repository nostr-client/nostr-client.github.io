# nostr-client.github.io

The front door of [nostr-client](https://github.com/nostr-client): a nostr
client built as independent, swappable, **no-build** vanilla JS parts, all
served from GitHub Pages.

**Live:** https://nostr-client.github.io/
